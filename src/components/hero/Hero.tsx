...
const AvatarFemale = ({ size = 60 }: { size?: number }) => (
  <svg width={size} height={size} viewBox="0 0 56 56" fill="none">
    ...
    <ellipse cx="28" cy="50" rx="14" ry="8" fill="#8B2248" />
    <rect x="22" y="35" width="12" height="9" rx="4" fill="#E8798C" />
    <ellipse cx="28" cy="25" rx="13" ry="14" fill="#E8798C" />
    <path
    ...
    <path
      ...
      fill="#C0415C"
    />
    <ellipse cx="15" cy="25" rx="2.5" ry="3.2" fill="#E8798C" />
    <ellipse cx="41" cy="25" rx="2.5" ry="3.2" fill="#E8798C" />
    <ellipse cx="22.5" cy="24" rx="2.8" ry="2.8" fill="white" />
    <ellipse cx="33.5" cy="24" rx="2.8" ry="2.8" fill="white" />
    <circle cx="23" cy="24.5" r="1.5" fill="#3d0018" />
    <circle cx="34" cy="24.5" r="1.5" fill="#3d0018" />
    <path
    ...
    <defs>
      <radialGradient id="fBg" cx="50%" cy="30%" r="70%">
        ...
        <stop offset="100%" stopColor="#7A1A35" />
      </radialGradient>
    </defs>
  </svg>
);
