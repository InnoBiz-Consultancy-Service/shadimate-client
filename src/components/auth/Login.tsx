        ...
        <GlassCard className="relative z-10 w-full max-w-md p-8 md:p-10">
          ...
          >
            ...
            <div className="flex items-center justify-between">
              ...
              <Link
                href="/forgot-password"
                className="text-xs text-white font-semibold hover:text-brand transition-colors duration-150 underline underline-offset-2"
              >
                Forgot password?
              </Link>
            </div>
          ...
          {/* FIX: High-contrast Create Account link */}
          <div className="animate-[fadeUp_0.6s_ease_0.55s_both] text-center mt-7">
            <p className="text-slate-200 text-sm">
              New to primehalf?{" "}
              <Link
                href="/registration"
                className="text-white font-bold underline underline-offset-2 hover:text-brand transition-colors duration-150"
              >
                Create account
              </Link>
            </p>
